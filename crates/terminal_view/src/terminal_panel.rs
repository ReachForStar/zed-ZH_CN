                    ...
                    .child(
                        PopoverMenu::new("terminal-tab-bar-popover-menu")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(t!("terminal_view.panel.new")),
                            )
                            ...
                            .menu(move |window, cx| {
                                ...
                                let menu = ContextMenu::build(window, cx, |menu, _, _| {
                                    menu.context(focus_handle.clone())
                                        .action(
                                            t!("terminal_view.panel.new_terminal"),
                                        ...
                                        .action(
                                            t!("terminal_view.panel.spawn_task"),
                    ...
                    .child(
                        PopoverMenu::new("terminal-pane-tab-bar-split")
                            .trigger_with_tooltip(
                                ...
                                Tooltip::text(t!("terminal_view.panel.split_pane")),
                            )
                            .anchor(Anchor::TopRight)
                            ...
                            .menu({
                                move |window, cx| {
                                    ContextMenu::build(window, cx, |menu, _, _| {
                                        ...
                                        .action(
                                            t!("terminal_view.panel.split_right"),
                                            SplitRight::default().boxed_clone(),
                                        )
                                        .action(
                                            t!("terminal_view.panel.split_left"),
                                            SplitLeft::default().boxed_clone(),
                                        )
                                        .action(
                                            t!("terminal_view.panel.split_up"),
                                            SplitUp::default().boxed_clone(),
                                        )
                                        .action(
                                            t!("terminal_view.panel.split_down"),
                    ...
                    .child({
                        ...
                        IconButton::new("toggle_zoom", IconName::Maximize)
                            ...
                            .tooltip(move |_window, cx| {
                                Tooltip::for_action(
                                    if zoomed {
                                        t!("terminal_view.panel.zoom_out")
                                    } else {
                                        t!("terminal_view.panel.zoom_in")
                                    },
                                    &ToggleZoom,
                                    cx,
                                )
        ...
        let popover_menu = PopoverMenu::new("settings-popover")
            ...
            .menu(move |window, cx| {
                Some(ContextMenu::build(window, cx, |context_menu, _, _| {
                    context_menu
                        .action(
                            t!("terminal_view.panel.open_settings"),
                            zed_actions::OpenSettings.boxed_clone(),
                        )
                        .action(
                            t!("terminal_view.panel.edit_settings_json"),
        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .justify_center()
                    .text_center()
                    .child(Label::new(t!("terminal_view.panel.failed_to_spawn")))
                    .child(
                    ...
                    .child(SplitButton::new(
                        ButtonLike::new("open-settings-ui")
                            .child(
                                Label::new(t!("terminal_view.panel.edit_settings"))
                                    .size(LabelSize::Small),
                            )
...
impl workspace::Item for FailedToSpawnTerminal {
    ...
    fn tab_content_text(&self, _detail: usize, _cx: &App) -> SharedString {
        t!("terminal_view.panel.failed_to_spawn").into()
    }
}
        ...
        IconButton::new("terminal_inline_assistant", IconName::ZedAssistant)
            ...
            .tooltip(move |_window, cx| {
                Tooltip::for_action_in(
                    t!("terminal_view.panel.inline_assist"),
