...
impl DebugPanel {
    ...
    pub(crate) fn top_controls_strip(
                ...
                .tooltip({
                    ...
                    move |_window, cx| {
                        Tooltip::for_action_in(
                            t!("debugger_ui.panel.start_debug_session"),
                            &crate::Start,
                            &focus_handle,
                            cx,
                        )
        ...
        let edit_debug_json_button = || {
            IconButton::new("debug-edit-debug-json", IconName::Code)
                ...
                .tooltip(Tooltip::text(t!("debugger_ui.panel.edit_debug_json")))
        };
        ...
        let documentation_button = || {
            IconButton::new("debug-open-documentation", IconName::CircleHelp)
                ...
                .tooltip(Tooltip::text(t!("debugger_ui.panel.open_documentation")))
        };
        ...
        let logs_button = || {
            IconButton::new("debug-open-logs", IconName::Notepad)
                ...
                .tooltip(Tooltip::text(t!("debugger_ui.panel.open_adapter_logs")))
        };
        ...
        let close_bottom_panel_button = {
            h_flex().pl_0p5().gap_1().child(Divider::vertical()).child(
                IconButton::new("debug-close-panel", IconName::Close)
                    ...
                    .tooltip(Tooltip::text(t!("debugger_ui.panel.close_panel"))),
            )
        };
                                        ...
                                        if thread_status == ThreadStatus::Running {
                                            this.child(
                                                ...
                                                .tooltip({
                                                    ...
                                                    move |_window, cx| {
                                                        Tooltip::for_action_in(
                                                            t!("debugger_ui.panel.pause_program"),
                                                            &Pause,
                                                            &focus_handle,
                                                            cx,
                                                        )
                                            ...
                                            .tooltip({
                                                ...
                                                move |_window, cx| {
                                                    Tooltip::for_action_in(
                                                        t!("debugger_ui.panel.continue_program"),
                                                        &Continue,
                                                        &focus_handle,
                                                        cx,
                                                    )
                                                ...
                                                |this| {
                                                    this.child(
                                                        ...
                                                        .tooltip({
                                                            ...
                                                            move |_window, cx| {
                                                                Tooltip::for_action_in(
                                                                    t!("debugger_ui.panel.continue_thread"),
                                                                    &ContinueThread,
                                                                    &focus_handle,
                                                                    cx,
                                                                )
                                    ...
                                    .child(
                                        IconButton::new("debug-restart", IconName::RotateCcw)
                                            ...
                                            .tooltip({
                                                ...
                                                move |_window, cx| {
                                                    Tooltip::for_action_in(
                                                        t!("debugger_ui.panel.rerun_session"),
                                                        &RerunSession,
                                                        &focus_handle,
                                                        cx,
                                                    )
                                            ...
                                            .tooltip({
                                                ...
                                                move |_window, cx| {
                                                    let label = if supports_terminate_threads {
                                                        t!("debugger_ui.panel.terminate_thread")
                                                    } else {
                                                        t!("debugger_ui.panel.terminate_all_threads")
                                                    };
                                                    Tooltip::for_action_in(
                                                        label,
                                                        &Stop,
    ...
    fn render_history_button(
        ...
        ButtonLike::new_rounded_left("debug-back-in-history")
            ...
            .tooltip(Tooltip::text(t!("debugger_ui.panel.step_back_history")))
                        ...
                        move |mut context_menu, _window, cx| {
                            ...
                            for (ix, _) in history.iter().enumerate().rev() {
                                context_menu = context_menu.entry(
                                    t!("debugger_ui.panel.history_entry", n = ix + 1),
                                    None,
                                    {
                                        let running_state = running_state.clone();
                                        move |_window, cx| {
                    ...
                    let welcome_experience = v_flex()
                        ...
                        .child(
                            Button::new(
                                ...
                                t!("debugger_ui.panel.new_session"),
                            )
                            .start_icon(
                        ...
                        .child(
                            Button::new(
                                "edit-debug-settings",
                                t!("debugger_ui.panel.edit_debug_json"),
                            )
                            .start_icon(
                        ...
                        .child(
                            Button::new(
                                "open-debugger-docs",
                                t!("debugger_ui.panel.debugger_docs"),
                            )
                            .start_icon(
                        ...
                        .child(
                            Button::new(
                                ...
                                t!("debugger_ui.panel.debugger_extensions"),
                            )
                            .start_icon(
                    ...
                    let breakpoint_list = v_flex()
                        ...
                        .child(
                            h_flex()
                                ...
                                .child(
                                    Label::new(t!("debugger_ui.panel.breakpoints_title"))
                        ...
                        .when(!has_breakpoints, |this| {
                            this.child(
                                v_flex().size_full().items_center().justify_center().child(
                                    Label::new(t!("debugger_ui.panel.no_breakpoints"))
                                        .size(LabelSize::Small)
                                        .color(Color::Muted),
                                ),
                            )
