            ...
            h_flex()
                ...
                .when(v.has_clipboard_content(window, cx), |el| {
                    ...
                    el.child(
                        CopyButton::new(("copy-output", v.entity_id()), "")
                            .tooltip_label(t!("repl.outputs.copy_output"))
                ...
                .when(v.has_buffer_content(window, cx), |el| {
                    ...
                    el.child(
                        ...
                        .tooltip(Tooltip::text(t!("repl.outputs.open_in_buffer")))
                        .on_click({
                    ...
                    h_flex()
                        ...
                        .child({
                            ...
                            CopyButton::new("copy-full-error", full_error)
                                .tooltip_label(t!("repl.outputs.copy_full_error"))
                        })
                        .child(
                            IconButton::new(
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        let status = match &self.status {
            ExecutionStatus::ConnectingToKernel => {
                Label::new(t!("repl.outputs.connecting_to_kernel"))
                    .color(Color::Muted)
                    .into_any_element()
            }
            ExecutionStatus::Executing => h_flex()
                ...
                .child(Label::new(t!("repl.outputs.executing")).color(Color::Muted))
                .into_any_element(),
            ExecutionStatus::Finished => Icon::new(IconName::Check)
                .size(IconSize::Small)
                .into_any_element(),
            ExecutionStatus::Unknown => Label::new(t!("repl.outputs.unknown_status"))
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::ShuttingDown => Label::new(t!("repl.outputs.kernel_shutting_down"))
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::Restarting => Label::new(t!("repl.outputs.kernel_restarting"))
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::Shutdown => Label::new(t!("repl.outputs.kernel_shutdown"))
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::Queued => Label::new(t!("repl.outputs.queued"))
                .color(Color::Muted)
                .into_any_element(),
            ExecutionStatus::KernelErrored(error) => {
                Label::new(t!("repl.outputs.kernel_error", error = error))
                    .color(Color::Error)
                    .into_any_element()
            }
        };
