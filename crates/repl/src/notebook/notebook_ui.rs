                        ...
                        Self::button_group(window, cx)
                            .child(
                                ...
                                .tooltip(move |window, cx| {
                                    Tooltip::for_action(
                                        t!("repl.notebook.execute_all_cells"),
                                        &RunAll,
                                        cx,
                                    )
                                })
                            ...
                            .child(
                                ...
                                .tooltip(move |window, cx| {
                                    Tooltip::for_action(
                                        t!("repl.notebook.clear_all_outputs"),
                                        &ClearOutputs,
                                        cx,
                                    )
                                })
                    ...
                    .child(
                        Self::button_group(window, cx)
                            ...
                            .child(
                                ...
                                .tooltip(move |window, cx| {
                                    Tooltip::for_action(
                                        t!("repl.notebook.move_cell_down"),
                                        &MoveCellDown,
                                        cx,
                                    )
                                })
                    ...
                    .child(
                        Self::button_group(window, cx)
                            .child(
                                ...
                                .tooltip(move |window, cx| {
                                    Tooltip::for_action(
                                        t!("repl.notebook.add_markdown_block"),
                                        &AddMarkdownBlock,
                                        cx,
                                    )
                                })
                            ...
                            .child(
                                ...
                                .tooltip(move |window, cx| {
                                    Tooltip::for_action(
                                        t!("repl.notebook.add_code_block"),
                                        &AddCodeBlock,
                                        cx,
                                    )
                                })
                ...
                v_flex()
                    ...
                    .child(
                        Self::render_notebook_control("more-menu", IconName::Ellipsis, window, cx)
                            .tooltip(move |window, cx| {
                                (Tooltip::text(t!("repl.notebook.more_options")))(window, cx)
                            }),
                    )
                    .child(Self::button_group(window, cx).child({
                        ...
                        IconButton::new("repl", icon)
                            ...
                            .tooltip(move |window, cx| {
                                Tooltip::text(t!(
                                    "repl.notebook.kernel_change_tooltip",
                                    name = kernel_name,
        ...
        h_flex()
            ...
            .child(
                KernelSelector::new(
                    ...
                    Tooltip::text(t!(
                        "repl.notebook.kernel_status_tooltip",
                        name = kernel_name,
                        status = kernel_status.to_string()
                    )),
                )
                ...
                h_flex()
                    ...
                    .child(
                        IconButton::new("restart-kernel", IconName::RotateCw)
                            ...
                            .tooltip(|window, cx| {
                                Tooltip::for_action(
                                    t!("repl.notebook.restart_kernel"),
                                    &RestartKernel,
                                    cx,
                                )
                            })
                    ...
                    .child(
                        IconButton::new("interrupt-kernel", IconName::Stop)
                            ...
                            .tooltip(|window, cx| {
                                Tooltip::for_action(
                                    t!("repl.notebook.interrupt_kernel"),
                                    &InterruptKernel,
                                    cx,
                                )
                            })
